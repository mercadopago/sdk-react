...
export interface IWalletBrickVisual {
   ...
   *
   * @see {@link https://www.mercadopago.com/developers/en/docs/checkout-bricks/wallet-brick/additional-customization/change-appearance Wallet # Additional Settings # Change appearance} documentation.
   */
...
export interface IWalletBrickTexts {
   ...
   *
   * @see {@link https://www.mercadopago.com/developers/en/docs/checkout-bricks/wallet-brick/additional-customization/change-texts Wallet # Additional Settings # Change Texts} documentation.
   */
  action?: 'pay' | 'buy';
  /**
...
export interface IWalletBrickCustomization {
   ...
   *
   * @tutorial {@link https://www.mercadopago.com/developers/en/docs/checkout-bricks/wallet-brick/additional-customization/change-texts Wallet # Additional Settings # Change Texts} documentation.
   */
   ...
   *
   * @tutorial {@link https://www.mercadopago.com/developers/en/docs/checkout-bricks/wallet-brick/additional-customization/change-appearance Wallet # Additional Settings # Change appearance} documentation.
   */
...
interface IWalletBrickCheckoutCustomization {
   ...
   *
   * @tutorial {@link https://www.mercadopago.com.br/developers/pt/docs/checkout-pro/checkout-customization/user-interface/color-style Checkout Theme customization} documentation.
   */
  theme?: {
