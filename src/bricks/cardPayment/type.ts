...
export type TCardPayment = {
  ...
  customization?: {
     ...
     * @see {@link https://www.mercadopago.com.br/developers/en/docs/checkout-bricks/card-payment-brick/additional-customization/change-texts Change texts} documentation.
     * @see {@link https://www.mercadopago.com.br/developers/en/docs/checkout-bricks/additional-content/set-theme Set theme} documentation.
